...
* [Ivy](https://github.com/Ivy-Interactive/Ivy-Framework) - Open-source .NET framework for building internal tools using a single C# codebase, enabling rapid development of CRMs, dashboards, and back-office apps.
